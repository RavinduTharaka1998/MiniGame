...
{
	$connection1 = mysqli_connect("localhost:3307","root","","isp_ctf_db");
          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="#" class="p-3 text-decoration-none text-white bold">Hackerboard</a>
                        ...
                        <tbody class="tbody-one">
						  ...
						  while($row = mysqli_fetch_array($search_result))
						  {
							  ...
							  <tr>
								 ...
								 <td><?php echo "<p>".$row['complete_level']."</p>";?></td>
								 <td><?php echo "<p>".$row['marks']."</p>";?></td>
