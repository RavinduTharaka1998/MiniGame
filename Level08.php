...
<head>
	...
	<script> 
		function Exit()
		{
			...
			{
				window.location.href="addmarks/addmarks7.php";
			}
		}
	</script>
...
<form method = "POST" action = "Level09.php">
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div>
            <div class="row justify-content-center hackerFont">
                <div class="col-xl-9">
                    <h3 class="display-1 bold color_white content__title">LEVEL-08<span class="vim-caret"></span></h3>
                      <br></br>
