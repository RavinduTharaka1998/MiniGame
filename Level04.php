...
<head>
	...
	<script> 
		function Exit()
		{
			...
			{
				window.location.href="addmarks/addmarks3.php";
			}
		}
	</script>
</head>
...
<form method ="POST" action = "Level05.php">
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div>
            <div class="row justify-content-center hackerFont">
                <div class="col-xl-9">
                    <h3 class="display-1 bold color_white content__title">LEVEL-04<span class="vim-caret"></span></h3>
                      <br></br>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control " id="name" placeholder="Type your Answer">
								 ...
								 <button type = "submit"  class="btn btn-outline-light btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter"   onclick="checkInput()">
                                 <h4><b>Submit</b></h4>
                                 </button>
