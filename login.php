          ...
          <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="#" class="p-3 text-decoration-none text-white bold">Login</a>
			...
			<form method = "POST" action = "LoginBackend.php">
						...
						<div class="row hackerFont">
							<div class="col-md-6">
								<div class="form-group">
									<input type="text" name = "username" class="form-control" id="team_name" placeholder="Username" required>
								</div>
								<div class="form-group">
				...
				<div class="row">
					<div class="col-xl-8">
						...
						<!--<input type = "submit" name = "Login" value = "Login"  class="btn btn-outline-light btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter">-->
						<button type = "submit" class="btn btn-outline-light btn-shadow px-3 my-2 ml-0 ml-sm-1 text-left typewriter" name = "Login">
						<h4><b>Login</b></h4>
						</button>
						
						<small id="registerHelp" class="mt-3 form-text text-muted">Not Registered? <a class="color_danger" href="register.php">Register here</a></small>
					</div>
				</div>
			</form>
        </div>
